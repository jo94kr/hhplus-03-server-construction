...
- AS-IS  
  ...
  ![콘서트_조회_일반조회.png](images%2F%C4%DC%BC%AD%C6%AE_%C1%B6%C8%B8_%C0%CF%B9%DD%C1%B6%C8%B8.png)

- TO-BE  
  Redis 캐시를 사용한 조회시 약 `47ms`로 DB 조회보다 약 2배 가량 차이  
  ![콘서트_조회_캐시조회.png](images%2F%C4%DC%BC%AD%C6%AE_%C1%B6%C8%B8_%C4%B3%BD%C3%C1%B6%C8%B8.png)
