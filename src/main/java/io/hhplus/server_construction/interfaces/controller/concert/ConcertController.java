...
public class ConcertController {
    ...
    @GetMapping()
    public ResponseEntity<Page<FindConcertListDto.Response>> findConcertList(@Schema(name = "대기열 토큰") @RequestHeader(name = "Authorization") String token,
    ...
    public ResponseEntity<List<FindConcertScheduleDto.Response>> findConcertSchedule(@Schema(name = "대기열 토큰") @RequestHeader("Authorization") String token,
    ...
    public ResponseEntity<List<FindConcertSeatDto.Response>> findConcertSeat(@Schema(name = "대기열 토큰") @RequestHeader("Authorization") String token,
                                                                             @Schema(name = "콘서트 Id") @PathVariable(name = "concertId") Long concertId,
