...
insert into concert_seat(id, concert_schdule_id, seat_num, grade, price, status, version, create_datetime)
values (1, 1, 'A01', 'GOLD', 3000, 'POSSIBLE', 1, now()),
       (2, 1, 'B01', 'SILVER', 2000, 'POSSIBLE', 1, now()),
       (3, 1, 'C01', 'BRONZE', 1000, 'POSSIBLE', 1, now()),
       (4, 2, 'A01', 'GOLD', 3000, 'POSSIBLE', 1, now()),
       (5, 2, 'A02', 'GOLD', 3000, 'POSSIBLE', 1, now()),
       (6, 2, 'A03', 'GOLD', 3000, 'PENDING', 1, now());
